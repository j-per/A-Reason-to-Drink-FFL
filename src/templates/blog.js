...
const Blog = props => {
    ...
    const options = {
        renderNode: {
            [BLOCKS.HEADING_1]: (node, children) => (<h1 className="uppercase">{children}</h1>),
            [BLOCKS.HEADING_2]: (node, children) => (<h2 className="uppercase">{children}</h2>),
            [BLOCKS.HEADING_3]: (node, children) => (<h3 className="uppercase">{children}</h3>),
            [BLOCKS.HEADING_4]: (node, children) => (<h4 className="uppercase">{children}</h4>),
            [BLOCKS.HEADING_5]: (node, children) => (<h5 className="uppercase">{children}</h5>),
